                    ...
                    <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right p-0"
                        ...
                        <div class="p-3">
                            <div class="row align-items-center">
                                <div class="col">
                                    <h5 class="m-0 font-size-16"> @lang('static.titles.notifications') (1) </h5>
                                </div>
                            </div>
                        </div>
                    ...
                    <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown"
                        ...
                        @auth
                            <img class="rounded-circle header-profile-user"
                                 src="{{asset('/storage/uploads/admins/'.auth()->user()->profilePhoto)}}"
                                 alt="{{auth()->user()->name}}">
                        @endauth
                    </button>
                    <div class="dropdown-menu dropdown-menu-right">
    ...
    <div data-simplebar class="h-100">
        ...
        <div class="p-4">
            ...
            <div class="custom-control custom-switch mb-5">
                ...
                <label class="custom-control-label" for="rtl-mode-switch">@lang('static.actions.modes.rtlmode')</label>
            </div>
